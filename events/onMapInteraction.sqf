		...
		case "Empty Hands": {
			...
			if(count _mapObjects > 0 && isNull cursorTarget) then {
				switch (_mapObjects select 0) do {
					case "sacks_goods": { [3,"Gathering goods...","AinvPknlMstpSnonWrflDnon_medic","AmovPknlMstpSnonWnonDnon_AmovPercMstpSnonWnonDnon"] spawn fnc_timer; _a = [["AL_apple",1],["AL_orange",1],["AL_potatoes",1]]; };
